...
<main class="flex flex-col justify-center mx-auto">
	<article class="prose my-8">
			<h1 class="h1 mb-0">What Counts</h1>
			<h4 class="h4 mt-0">Privacy Policy and Terms of Use</h4>
			<div>
				<h2>Privacy Policy</h2>
				<div>
					<p>
						Stephen Richter built the What Counts app as a Free app. This SERVICE is provided by
						Stephen Richter at no cost and is intended for use as is.
					</p>
					<p>
					...
					<p>
						...
						Conditions, which are accessible at What Counts unless otherwise defined in this Privacy
						Policy.
					</p>
					...
					<p>
						...
						contact me at stephenrichter15@gmail.com.
					</p>
				</div>
				<div>
					...
					<p>
						...
						property rights related to it, still belong to Stephen Richter.
					</p>
					<p>
						Stephen Richter is committed to ensuring that the app is as useful and efficient as
					...
					<p>
						The What Counts app stores and processes personal data that you have provided to us, to
						...
						could mean that the What Counts app won’t work properly or at all.
					</p>
					...
					<p>
						You should be aware that there are certain things that Stephen Richter will not take
						...
						provider, but Stephen Richter cannot take responsibility for the app not working at full
					...
					<p>
						Along the same lines, Stephen Richter cannot always take responsibility for the way you
						use the app i.e. You need to make sure that your device stays charged – if it runs out
						of battery and you can’t turn it on to avail the Service, Stephen Richter cannot accept
						responsibility.
					</p>
					<p>
						With respect to Stephen Richter’s responsibility for your use of the app, when you’re
						...
						information to us so that we can make it available to you. Stephen Richter accepts no
					...
					<p>
						...
						&amp; iOS – the requirements for the both systems(and for any additional systems we
						decide to extend the availability of the app to) may change, and you’ll need to download
						the updates if you want to keep using the app. Stephen Richter does not promise that it
						will always update the app so that it is relevant to you and/or works with the Android
						&amp; iOS version that you have installed on your device. However, you promise to always
					...
					<p>These terms and conditions are effective as of 2023-03-24</p>
					<p><strong>Contact Us</strong></p>
					<p>
						If you have any questions or suggestions about my Terms and Conditions, do not hesitate
						to contact me at stephenrichter15@gmail.com.
					</p>
					<p>
